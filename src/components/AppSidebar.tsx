...
export function AppSidebar() {
  ...
  const getNavCls = ({ isActive }: { isActive: boolean }) =>
    isActive 
      ...
      : "text-gray-300 hover:bg-gradient-to-r hover:from-gray-700 hover:to-gray-600 hover:text-white rounded-lg mx-2 transition-all duration-200 ease-in-out hover:shadow-md";

  return (
    <Sidebar
      className={`${state === "collapsed" ? "w-0" : "w-64"} bg-gradient-to-b from-gray-900 via-gray-900 to-gray-800 border-r border-gray-700/50 transition-all duration-300 ease-in-out overflow-hidden`}
      collapsible="icon"
    >
      <SidebarContent className="bg-gradient-to-b from-gray-900 via-gray-900 to-gray-800 h-full">
